...
class BacktestBase(object):
    ...
    def plot_data(self, cols=None):
        ...
        self.data[cols].plot(figsize=(10,6), title=self.symbol, lw=0.8)
    ...
    def update_results(self, bar):
        ...
        date, price = self.get_time_price(bar)
        net_wealth = self.units * price + self.amount ## NET_WEALTH AKA EQUITY
        #TODO: units needs to be a dictionary of positions for eached asset, keyed by the asset symbol.
        #TODO: will need to also fetch the price from a dictionary/dataframe where prices will be stored.
